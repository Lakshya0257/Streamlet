pub mod search {
    ...
    pub async fn search_series(client: reqwest::Client, query: &str) -> Value {
        ...
        let endpoint = format!("{}?query={}", endpoints::endpoints::SEARCHSERIES, query); // Append the query parameter to the endpoint URL
